...
const { Value, event, block, cond, eq, set, Clock, startClock, stopClock, debug, clockRunning, timing, interpolate, Extrapolate, concat } = Animated
                ...
                <Animated.View style={{...StyleSheet.absoluteFill, transform: [{ translateY: this.bgY}]}}>
                    ...
                    >
                        ...
                        <Image
                            ...
                            height={height + 50}
                            style={{ flex: 1, width: undefined, height: undefined}} href={require('../../assets/leaves.jpeg')}
                            clipPath="url(#clip)"
                        />
                    </Svg>
